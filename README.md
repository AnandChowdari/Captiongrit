# Captiongrit — Adobe After Effects & Premiere Pro CEP Plugin
...
The easiest way to install the plugin and its dependencies is to use the automated installers:

**Windows:** Double-click `install.bat`
**Mac:** Open Terminal, navigate to this folder, and run `./install.sh`
...
**Windows:**
```
C:\Program Files (x86)\Common Files\Adobe\CEP\extensions\com.captiongrit.panel
```

**Mac:**
```
/Library/Application Support/Adobe/CEP/extensions/com.captiongrit.panel
```

Copy the entire `com.captiongrit.panel` folder to the appropriate path above.
...
2. Go to **Window → Extensions → Captiongrit**
3. The Captiongrit panel will open
